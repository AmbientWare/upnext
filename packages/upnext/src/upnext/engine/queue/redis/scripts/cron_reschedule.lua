-- Atomic cron reschedule mutation.
...
--   "NOOP_EXISTING_OWNER:<owner_job_id>"
...
if not reserved then
    ...
    local current_owner = redis.call("HGET", cron_registry_key, cron_key)
    if current_owner then
        return "NOOP_EXISTING_OWNER:" .. current_owner
    end
    return "NOOP_EXISTING_OWNER:" .. job_id
end
