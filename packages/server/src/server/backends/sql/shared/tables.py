...
class JobHistoryTable(Base):
    ...
    __table_args__ = (
        ...
        Index("ix_job_history_workspace_id", "workspace_id"),
        ...
        Index("ix_job_history_deployment_created_at", "workspace_id", "created_at"),
        Index("ix_job_history_deployment_status", "workspace_id", "status"),
...
class ArtifactTable(Base):
    ...
    # Indexes
    __table_args__ = (
        Index("ix_artifacts_workspace_id", "workspace_id"),
...
class PendingArtifactTable(Base):
    ...
    # Indexes
    __table_args__ = (
        Index("ix_pending_artifacts_workspace_id", "workspace_id"),
