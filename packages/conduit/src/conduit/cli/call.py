...
from conduit.cli._console import console, error, error_panel, nl, setup_logging
...
def call(
    ...
    Examples:
        conduit call service.py process_order order_id=123
        conduit call service.py send_email to=user@example.com subject="Hello"
        conduit call service.py process_order --json '{"order_id": "123"}'
    """
