...
| `UPNEXT_DEPLOYMENT_ID` | `local` | Deployment namespace for runtime Redis state |
...
| `UPNEXT_DEFAULT_DEPLOYMENT_ID` | `local` | Deployment id served by this runtime instance |
