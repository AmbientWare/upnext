...
Serve frontend assets directly from your API with `api.static()`:
...
This mounts built static assets at the given path. When deployed, UpNext automatically runs the build command and serves the output. See the [Static Files](/concepts/static-files) guide for full details.
