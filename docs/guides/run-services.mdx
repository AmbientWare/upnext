...
If authentication is enabled, also set `UPNEXT_API_KEY`. For self-hosted setups this is the single configured bearer token. See the [Authentication guide](/guides/authentication) for details.
